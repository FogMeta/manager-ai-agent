    ...
    >
      ...
      >
        ...
        <form onSubmit={sendMessage} className="flex w-full flex-col">
          ...
          <div className="flex items-center w-full mt-4 chat-container">
            <textarea
              ref={textareaRef}
              style={{
                height: height,
                maxHeight: `${maxHeight}px`,
                overflowY: parseInt(height) >= maxHeight ? 'scroll' : 'hidden',
                resize: 'none',
              }}
              rows={1}
              onInput={handleInput}
              className="grow mr-4 p-2 rounded"
              value={input}
